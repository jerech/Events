					...
					<div class="ibox-content">
						...
						<div class="row">
							<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                ...
                                // { 
                                ?>
				            	<!-- <a onclick="fnClickAdd('<?=BASE_URL;?>novedades/add_edit');" href="javascript:void(0);" class="btn btn-primary ">
				            		Nuevo
				            	</a> -->
				            	<?php
                                // }
                                ...
                                // {
                                ?>
				            	<!-- <a onclick="fnClickEdit('<?=BASE_URL;?>novedades/add_edit','novedad');" href="javascript:void(0);" class="btn btn-primary ">
				            		Modificar
				            	</a> -->
				            	<?php
                                // }
                                ...
                                // {
                                ?>
                                <!-- <a onclick="fnClickDelete('novedad');" href="javascript:void(0);" class="btn btn-primary ">
				            		Eliminar
				            	</a> -->
                                <?php
                                // }
						...
						<div class="row alerta_editar">
							<div class="alert alert-danger " >
                                <span id="mensaje_editar">Seleccionar la novedad que desea modificar</span>
                            </div>
						</div>
						<div class="row alerta_success" style="display:<?=(isset($result_save))?'block':'none';?>">
							<div class="alert alert-success " >
                                <span id="mensaje_editar">La novedad se guardo correctamente</span>
                            </div>
						</div>
                                    ...
                                    foreach($aNovedades as $objeto)
                    				{
                    					...
                    					?>
                    						<tr>
                                                ...
                                                <td><?=$empresa;?></td>
                                                <td>
                                                    <button type="button" class="btn btn-xs btn-white" onclick="fnOpenVisualize('<?php echo BASE_URL ?>novedades/visualizar', '<?php echo $objeto->getId(); ?>')" title="Visualizar">
                                                        <i class="fa fa-eye"></i>
                                                    </button>                  
                                                </td>
                    						</tr>
