...
class Alertas
{
    ...
    function agregar(){
        ...
        $sql="INSERT INTO alertas (observacion,responsable,idasignacion,leido,estado_registro,empresa_numero,updated_at,created_at) 
    ...
    function modificar(){
        ...
        $sql="UPDATE alertas SET observacion='".$this->getObservacion()."',
