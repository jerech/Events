            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Listado de Tipos de novedad</h5>
					...
					<div class="ibox-content">
						...
						<div class="row">
							<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                ...
                                { 
                                ?>
				            	<a onclick="fnClickAdd('<?=BASE_URL;?>tipos_novedad/add_edit');" href="javascript:void(0);" class="btn btn-primary ">
				            		Nuevo
				            	</a>
				            	<?php
                                }
                                ...
                                {
                                ?>
				            	<a onclick="fnClickEdit('<?=BASE_URL;?>tipos_novedad/add_edit','tipo novedad');" href="javascript:void(0);" class="btn btn-primary ">
				            		Modificar
				            	</a>
				            	<?php
                                }
                                ...
                                {
                                ?>
                                <a onclick="fnClickDelete('tipo novedad');" href="javascript:void(0);" class="btn btn-primary ">
				            		Eliminar
				            	</a>
                                <?php
                                }
						...
						<div class="row alerta_editar">
							<div class="alert alert-danger " >
                                <span id="mensaje_editar">Seleccionar el tipo de novedad que desea modificar</span>
                            </div>
						</div>
						<div class="row alerta_success" style="display:<?=(isset($result_save))?'block':'none';?>">
							<div class="alert alert-success " >
                                <span id="mensaje_editar">Tipo de novedad <b><?=(isset($_POST['nombre']))?$_POST['nombre']:'';?></b> se guardo correctamente</span>
                            </div>
						</div>
