...
class TipoAsistentes
{
    ...
    function __construct($id="")
    {
        ...
        if ($id!="")
        {
            $sql="SELECT * FROM tipo_asistentes WHERE id=".$id." ";
            //echo $sql;
    ...
    public function buscar($aWhere=array(),$aOrWhere=array(),$page="",$per_page="20")
    {
        ...
        $resultado=array();
     		...
     		$sql="SELECT * FROM tipo_asistentes 
          ";
    ...
    function agregar(){
        ...
        $sql="INSERT INTO tipo_asistentes (descripcion,estado,empresa_numero) 
    ...
    function modificar(){
        ...
        $sql="UPDATE tipo_asistentes SET 
