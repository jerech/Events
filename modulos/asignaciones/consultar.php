					...
					<div class="ibox-content">
						...
						<div class="row">
							<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                ...
                                { 
                                ?>
				            	<a onclick="fnClickAdd('<?=BASE_URL;?>asignaciones/add_edit');" href="javascript:void(0);" class="btn btn-primary ">
				            		Nuevo
				            	</a>
				            	<?php
                                }
                                ...
                                {
                                ?>
				            	<a onclick="fnClickEdit('<?=BASE_URL;?>asignaciones/add_edit','asignacion');" href="javascript:void(0);" class="btn btn-primary ">
				            		Modificar
				            	</a>
				            	<?php
                                }
                                ...
                                {
                                ?>
                                <a onclick="fnClickDelete('asignacion');" href="javascript:void(0);" class="btn btn-primary ">
				            		Eliminar
				            	</a>
                                <?php
                                }
                                    ...
                                    foreach($aAsignaciones as $objeto)
                    				{
                    					...
                    					?>
                    						<tr>
                    						    ...
                    						    <td>
                                                    <button type="button" class="btn btn-xs btn-white" onclick="fnOpenVisualize('<?php echo BASE_URL ?>asignaciones/visualizar', '<?php echo $objeto->getId(); ?>')" title="Visualizar">
                                                        <i class="fa fa-eye"></i>
                                                    </button>                  
                                                </td>
                                            </tr>
