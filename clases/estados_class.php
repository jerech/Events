...
class Estados
{
    ...
    function agregar(){
        ...
        $sql="INSERT INTO estados (descripcion,empresa_numero,updated_at,created_at) 
              VALUES ('".$this->getDescripcion()."','".$this->getEmpresa_numero()."',NOW(),NOW())";
    ...
    function modificar(){
        ...
        $sql="UPDATE estados SET descripcion='".$this->getDescripcion()."',
