...
class Tipos_asignacion
{
    ...
    function __construct($id="")
    {
        ...
        if ($id!="")
        {
            $sql="SELECT * FROM tipos_asignacion WHERE id=".$id." ";
            //echo $sql;
    ...
    public function buscar($aWhere=array(),$aOrWhere=array(),$page="",$per_page="20")
    {
        ...
        $resultado=array();
     		...
     		$sql="SELECT * FROM tipos_asignacion 
          ";
    ...
    function agregar(){
        ...
        $sql="INSERT INTO tipos_asignacion (nombre,descripcion,estado_registro,empresa_numero,updated_at,created_at) 
    ...
    function modificar(){
        ...
        $sql="UPDATE tipos_asignacion SET nombre='".$this->getNombre()."',
    ...
    function eliminar(){
        ...
        $sql="UPDATE tipos_asignacion SET 
                    estado_registro='".$this->getEstado_registro()."',
                    updated_at=NOW()
                WHERE id='".$this->getId()."'";
