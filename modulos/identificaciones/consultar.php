            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Listado de Identificaciones</h5>
					...
					<div class="ibox-content">
						...
						<div class="row">
							<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                ...
                                { 
                                ?>
				            	<a onclick="fnClickAdd('<?=BASE_URL;?>identificaciones/add_edit');" href="javascript:void(0);" class="btn btn-primary ">
				            		Nuevo
				            	</a>
				            	<?php
                                }
                                ...
                                {
                                ?>
				            	<a onclick="fnClickEdit('<?=BASE_URL;?>identificaciones/add_edit','area');" href="javascript:void(0);" class="btn btn-primary ">
				            		Modificar
				            	</a>
				            	<?php
                                }
						...
						<div class="row alerta_editar">
							<div class="alert alert-danger " >
                                <span id="mensaje_editar">Seleccionar la identificacion que desea modificar</span>
                            </div>
						</div>
						<div class="row alerta_success" style="display:<?=(isset($result_save))?'block':'none';?>">
							<div class="alert alert-success " >
                                <span id="mensaje_editar">Identificacion <b><?=(isset($_POST['nombre']))?$_POST['nombre']:'';?></b> se guardo correctamente</span>
                            </div>
						</div>
					<table class="table table-striped table-bordered table-hover dataTables-example" >
			            ...
			            <tbody>
			            	<?php
			            	if ($aIdentificaciones)
			            	{
			            		if (count($aIdentificaciones)>0)
                    			{
                    				foreach($aIdentificaciones as $objeto)
                    				{
                    					unset($aWhere);
                                        ...
                                        if ($objeto->getEmpresa_numero()!="")
                                        {
                                            ...
                                            unset($aWhere2);
                                            $aWhere2['id']=$objeto->getId_zona();
                                            $aZonas=$objZonas->buscar($aWhere2);
                                    
                                            unset($aWhere2);
                                            $aWhere2['id']=$objeto->getId_tipo();
                                            $aTipos=$objTipoAsistentes->buscar($aWhere2);
                    					...
                    					?>
                    						<tr>
                                                ...
                                                <td><span class="label" style="background-color:<?=$objeto->getColor();?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
                                                <td><?=$aZonas[0]->getDescripcion();?></td>
                                                <td><?=$aTipos[0]->getDescripcion();?></td>
