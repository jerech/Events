...
class Eventos
{
    ...
    function agregar(){
        ...
        $sql="INSERT INTO evento (nombre, descripcion,estado,empresa_numero) 
              VALUES ('".$this->getNombre()."','".$this->getDescripcion()."','".$this->getEstado_registro()."','".$this->getEmpresa_numero()."')";
