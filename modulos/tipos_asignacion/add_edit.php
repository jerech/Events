            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Administrar Tipos de asignacion</h5>
                    ...
                    <div class="ibox-content">
                    	...
                    	<form name="formulario" action="<?=BASE_URL;?>tipos_asignacion/action" method="post" class="form-horizontal">
							...
							<div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <button class="btn btn-white" type="button" onclick="location.href='<?=BASE_URL;?>tipos_asignacion/&m=<?=$_REQUEST["m"];?>';">Cancelar</button>
