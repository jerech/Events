					...
					<div class="ibox-content">
						...
						<div class="row">
							<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                ...
                                { 
                                ?>
				            	<a onclick="fnClickAdd('<?=BASE_URL;?>estados/add_edit');" href="javascript:void(0);" class="btn btn-primary ">
				            		Nuevo
				            	</a>
				            	<?php
                                }
                                ...
                                {
                                ?>
				            	<a onclick="fnClickEdit('<?=BASE_URL;?>estados/add_edit','estado');" href="javascript:void(0);" class="btn btn-primary ">
				            		Modificar
				            	</a>
				            	<?php
                                }
                                ...
                                {
                                ?>
                                <a onclick="fnClickDelete('estado');" href="javascript:void(0);" class="btn btn-primary ">
				            		Eliminar
				            	</a>
                                <?php
                                }
						...
						<div class="row alerta_editar">
							<div class="alert alert-danger " >
                                <span id="mensaje_editar">Seleccionar el estado que desea modificar</span>
                            </div>
						</div>
						<div class="row alerta_success" style="display:<?=(isset($result_save))?'block':'none';?>">
							<div class="alert alert-success " >
                                <span id="mensaje_editar">Estado <b><?=(isset($_POST['descripcion']))?$_POST['descripcion']:'';?></b> se guardo correctamente</span>
                            </div>
						</div>
                    				...
                    				foreach($aEstados as $objeto)
                    				{
                    					...
                    					?>
                    						<tr>
                    							...
                    							<td><?=$objeto->getEstado_registro();?></td>
